## Build dev.templates.tests.full_20190207.2
- **Build result:** `failed`
- **Build queued:** 2/7/2019 1:51:17 PM
- **Build duration:** 27.99 minutes
### Details
Build [dev.templates.tests.full_20190207.2](https://winappstudio.visualstudio.com/web/build.aspx?pcguid=a4ef43be-68ce-4195-a619-079b4d9834c2&builduri=vstfs%3a%2f%2f%2fBuild%2fBuild%2f27053) failed
...
+ Process completed with exit code 21 and had 2 error(s) written to the error stream.

Find detailed information in the [build log files](https://uwpctdiags.blob.core.windows.net/buildlogs/dev.templates.tests.full_20190207.2_logs.zip)
